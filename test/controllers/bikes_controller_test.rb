...
class BikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post bikes_url, params: { bike: { color: @bike.color, family: @bike.family, make: @bike.make, tyre_size: @bike.tyre_size } }
    end
  ...
  test "should update bike" do
    patch bike_url(@bike), params: { bike: { color: @bike.color, family: @bike.family, make: @bike.make, tyre_size: @bike.tyre_size } }
