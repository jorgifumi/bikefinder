...
class MakesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create make" do
    assert_difference('Make.count') do
      post makes_url, params: { make: { address: @make.address, logo_url: @make.logo_url, name: @make.name, web_url: @make.web_url } }
    end
  ...
  test "should update make" do
    patch make_url(@make), params: { make: { address: @make.address, logo_url: @make.logo_url, name: @make.name, web_url: @make.web_url } }
